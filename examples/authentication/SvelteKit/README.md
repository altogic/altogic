...
Replacing `routes/+page.svelte` with the following code:
```javascript
...
Replacing  `routes/profile/+page.svelte` with the following code:
```javascript
...
Replacing `routes/magic-link/+page.svelte` with the following code:
```javascript
