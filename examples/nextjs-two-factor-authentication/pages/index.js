...
export default function Home() {
  return (
    <div className="py-2">
      <Head>
        <title>Two Factor Authentication Demo App</title>
        <meta
          name="description"
          content=" This is an two-factor authentication demo app created using the client API
          of Altogic."
        />
      ...
      <div className="min-h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8  ">
        ...
        <p className="mt-8 mb-8 text-lg text-center">
          This is an two-factor authentication demo app created using the client
          API of Altogic.
        </p>
        <div className="grid lg:grid-cols-2 mx-auto  gap-16">
          ...
          <div className="text-center">
            <a
              className="text-gray-500 text-base"
              href="https://www.youtube.com/watch?v=iZHgR1_W8vk"
              target="_blank"
              rel="noopener noreferrer"
            >
              <div className="max-w-sm rounded overflow-hidden shadow-md my-5 h-48 hover:text-white text-[#1976d2] hover:bg-[#1976d2]">
