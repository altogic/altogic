...
function Profile(props) {
  ...
  return context.allSessionsList != null ? (
    <div className="min-h-screen flex items-start justify-center px-4 sm:px-6 lg:px-8 bg-slate-100 ">
      <div className="mt-4">
        <div className=" bg-white space-y-6 px-3 py-12 justify-centers shadow rounded">
          <ProfilePhoto
