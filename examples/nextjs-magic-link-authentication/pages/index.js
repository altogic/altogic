    ...
    <div className="py-2">
      <div className="min-h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8  ">
        ...
        <p className="mt-8 mb-8 text-lg text-center">
          This is a magic link authentication demo app created using the client
          API of Altogic.
        </p>
        <div className="grid lg:grid-cols-2 mx-auto  gap-16">
          ...
          <div className="text-center">
            <a
              ...
              href="https://github.com/altogic/altogic/tree/main/examples/nextjs-magic-link-authentication"
              target="_blank"
