        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10">
            ...
            <div className="mt-10 flex flex-row mx-auto justify-center">
              ...
              {/* Display a button to signout users */}
              <button
                onClick={() => handleSignOut()}
                className="ml-4 bg-red-600 border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
              >
                Sign out
              </button>
            </div>
